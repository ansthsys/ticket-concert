            ...
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 border-bottom">
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 link-body-emphasis text-decoration-none"
                        href="{{ route('concert') }}">Concert</a>
                    @auth
                        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="{{ route('myTicket') }}">My
                            Tickets</a>
                        @if (Auth::user()->role == 'admin')
                            <a class="me-3 py-2 link-body-emphasis text-decoration-none"
                                href="{{ route('management.buyer') }}">Buyer</a>
                            <a class="me-3 py-2 link-body-emphasis text-decoration-none"
                                href="{{ route('management.process') }}">Process Ticket</a>
                        @endif
                        <a class="btn btn-primary rounded-pill me-3 py-2 px-3 text-decoration-none"
                            href="{{ route('logout') }}"
                            onclick="
